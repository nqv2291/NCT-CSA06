...
FROM Customers RIGHT JOIN Orders ON Orders.CustomerID = Customers.CustomerID
GROUP BY Customers.Country
ORDER BY COUNT(Orders.OrderID) DESC

-- 3
SELECT DISTINCT Products.ProductID, Products.ProductName, OrderDetails.Quantity, Products.Price 
FROM Products FULL JOIN OrderDetails ON Products.ProductID = OrderDetails.ProductID
