...
province_list = [
    ('Thành phố Hà Nội', 'Thành phố Trung ương',
     'Đồng bằng sông Hồng', 3358.6, 8093.9),
    ...
    ('Thành phố Hải Phòng', 'Thành phố Trung ương',
     'Đồng bằng sông Hồng', 1561.8, 2033.3),
    ...
    ('Thành phố Cần Thơ', 'Thành phố Trung ương',
     'Đồng bằng sông Cửu Long', 1439.0, 1236.0),
...
# Get the memory usage (including object datatype) of the whole df
total_memory = df.memory_usage(deep=True).sum()
print(f"This df needs {total_memory} bytes.")

# Get the memory usage (including object datatype) of a single column of df
single_memory = df.memory_usage(deep=True)
